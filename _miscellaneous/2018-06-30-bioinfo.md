...
Every now and then, I come across papers describing new tools and software for some kind of metagenomics or amplicon sequencing related analysis. Even though I might not need them at that particular moment, I make a note in case I would like to use them in a future project. 

So, without further ado, here is what I have gathered so far. Of course, some of the tools may not be maintained anymore. And, it goes without saying, this is a non-exhaustive list of software; for sure there are twice as more out there that I have missed. 
...
| NGLess | domain-specific language for NGS (next-generation sequencing data) processing |  | http://ngless.embl.de/ |
...
| SLIM | web app providing an easy GUI which wrap bioinformatics tools for amplicon sequencing analysis | 10.1186/s12859-019-2663-2 | https://github.com/yoann-dufresne/SLIM |
...
| NGLess | NGS Processing with Less Work |  | http://ngless.embl.de/ |
...
| WHAM! | Workflow Hub for Automated Metagenomic Exploration | 10.1186/s12864-018-4870-z | https://github.com/ruggleslab/jukebox/tree/master/wham_v1 |
...
| proGenomes2 | improved database for accurate and consistent habitat, taxonomic and functional annotations of prokaryotic genomes | 10.1093/nar/gkz1002 | http://progenomes.embl.de/ |
...
| MiGA | Microbial Genomes Atlas Online | 10.1093/nar/gky467 | http://www.microbial-genomes.org/ |
...
| SCRAPP | Species Counting on Reference trees viA Phylogenetic Placements | 10.1101/2020.02.28.969980 | https://github.com/pbdas/scrapp |
...
| SMEG | Strain-level Metagenomic Estimation of Growth rate | 10.1126/sciadv.aaz2299 | https://github.com/ohlab/SMEG |
...
| Cviewer | A Java-based statistical framework for integration of shotgun metagenomics with other omics technologies |  | https://github.com/KociOrges/cviewer |
...
| MUFFIN | hybrid assembly and differential binning workflow for metagenomics, transcriptomics and pathway analysis. | 10.1101/2020.02.08.939843 | https://github.com/RVanDamme/MUFFIN |
...
| decontam | Identifying contaminants in marker-gene and metagenomics data | 10.1186/s40168-018-0605-2 | https://github.com/benjjneb/decontam |
...
| MiCoNE  | Microbial Co-occurrence Network Explorer | 10.1101/2020.09.23.309781 | https://github.com/segrelab/MiCoNE |
...
| METABOLIC | high-throughput profiling of microbial genomes | 10.1186/s40168-021-01213-8 | https://github.com/AnantharamanLab/METABOLIC |
...
| METABOLIC | METabolic And BiogeOchemistry anaLyses In miCrobes |  | https://github.com/AnantharamanLab/METABOLIC |
...
| SituSeq |  |  | https://github.com/jkorz/SituSeq |
| PhiSpy | identifies prophages in Bacterial (and probably Archaeal) genomes |  | https://github.com/linsalrob/PhiSpy |
...
| mapDamage | tracks and quantifies DNA damage patterns among ancient DNA sequencing reads  | 10.1093/bioinformatics/btt193 | https://github.com/ginolhac/mapDamage |
...
| mOTUpan | a robust Bayesian approach to leverage metagenome-assembled genomes for core-genome estimation | 10.1093/nargab/lqac060 | https://github.com/moritzbuck/mOTUlizer |
...
| APSCALE | analyses of DNA Meta-barcoding data | 10.1093/bioinformatics/btac588 | https://github.com/DominikBuchner/apscale |
...
| CoverM | DNA read coverage and relative abundance calculator focused on metagenomics applications |  | https://github.com/wwood/CoverM |
...
|VIRify|detection, annotation and taxonomic classification pipeline of viruses|10.1101/2022.08.22.504484|https://github.com/EBI-Metagenomics/emg-viral-pipeline|
...
|stRainy|assembly-based metagenomic strain phasing using long reads|10.1101/2023.01.31.526521|https://github.com/katerinakazantseva/stRainy|
...
|hybracter|Hybrid (and long-only) bacterial assembly pipeline||https://github.com/gbouras13/hybracter|
...
|plassembler|Automated Bacterial Plasmid Assembly Program||https://github.com/gbouras13/plassembler|
...
|plastiC|pipeline for recovery and characterization of plastid genomes from metagenomic datasets|10.1101/2022.12.23.521586|https://github.com/Finn-Lab/plastiC|
...
|Phables|from fragmented assemblies to high-quality bacteriophage genomes|10.1101/2023.04.04.535632|https://github.com/Vini2/phables|
|||||
