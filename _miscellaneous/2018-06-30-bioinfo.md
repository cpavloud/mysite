...
| TaxonTableTools  | graphical user interface software to explore and visualise DNA metabarcoding data | 10.1111/1755-0998.13358 | https://github.com/TillMacher/TaxonTableTools |
| TaxonTableTools2  | easy-to-use graphical software designed for the analysis and visualization of DNA metabarcoding data | 10.1111/1755-0998.13358 | https://github.com/TillMacher/TaxonTableTools2 |
...
| EukMetaSanity | prediction of eukaryote genomes | 10.12688/f1000research.129161.1 | https://github.com/cjneely10/EukMetaSanity |
...
|MVP|Modular Viromics Pipeline|10.1128/msystems.00888-24|https://gitlab.com/ccoclet/mvp|
...
|QuickVariants|Fast and Accurate Variant Identification Tool for Sequencing-Based Studies|10.1186/s12915-024-01891-4|https://github.com/caozhichongchong/QuickVariants|
...
|phold|Phage Annotation using Protein Structures|10.1101/2025.08.05.668817|https://github.com/gbouras13/phold|
...
|mettannotator|a comprehensive and scalable Nextflow annotation pipeline for prokaryotic assemblies|10.1093/bioinformatics/btaf037|https://github.com/EBI-Metagenomics/mettannotator|
...
|Microbial Abundances Retrieved from Sequencing data—automated NCBI Taxonomy (MARS)|processing of metagenomic datasets, taxonomic name resolution, and mapping to resources|10.1093/bioadv/vbae068|https://github.com/ThieleLab/mars-pipeline ; https://mars-pipeline.streamlit.app/along|
...
|DFAST_QC|quality assessment and taxonomic identification tool for prokaryotic Genomes|10.1186/s12859-024-06030-y|https://dfast.ddbj.nig.ac.jp/dqc/submit/|
|NMDC Data and Metadata R and Python Sample Jupyter Notebooks|||https://github.com/microbiomedata/nmdc_notebooks|
|MicrobiomeNet|comprehensive database that brings together known statistical associations and genome-scale metabolic models (GEMs)|10.1093/nar/gkae944|https://www.microbiomenet.com/|
|MicroKPNN-MT|predicting human phenotype based on microbiome data|10.1093/bioadv/vbae203|https://github.com/mgtools/MicroKPNN-MT|
|BlobToolKit|Identification and analysis of non-target data in all Eukaryotic genome projects|10.1534/g3.119.400908|https://blobtoolkit.genomehubs.org/|
|kMetaShot|fast and reliable taxonomy classifier for metagenome-assembled genomes|10.1093/bib/bbae680|https://github.com/gdefazio/kMetaShot|
|Prophage-DB|comprehensive database to explore diversity, distribution, and ecology of prophages|10.1186/s40793-024-00659-1|https://github.com/AnantharamanLab/Prophage-DB|
|Human Microbiome Compendium|dataset of the human microbiome|10.1016/j.cell.2024.12.017|https://microbiomap.org/|
|LADiM |Lagrangian Advection and Diffusion Model||https://github.com/bjornaa/ladim1|
|Fundamentals of Biological Data Analysis|||https://github.com/kaumudiprabhakara/fundamentals-of-biological-data-analysis/|
|BalticMicrobeDB| interface to meta-omic data for the Baltic Sea|10.1038/sdata.2018.146|https://barm.scilifelab.se|
|Baltic Sea Reference Metagenome (BARM)|A set of tools that are useful to reuse the Baltic Sea Reference Metagenome|10.1038/sdata.2018.146|https://github.com/EnvGen/BARM_tools|
|GAM-NICHE|build Species Distribution Models (SDMs) under the ecological niche theory|10.57762/fzpy-6w51|https://github.com/Fundacion-AZTI/gam-niche|
|EukDetect|identify eukaryotes in shotgun metagenomic sequencing data|10.1186/s40168-021-01015-y|https://github.com/allind/EukDetect|
|SimpleMetaPipeline|metabarcoding pipeline|10.1111/2041-210X.14434|https://github.com/J-Cos/SimpleMetaPackage|
|Bin Chicken|targeted metagenomic coassembly for the efficient recovery of novel genomes|10.1101/2024.11.24.625082|https://aroneys.github.io/binchicken/|
|Mendelian randomization |distinguish correlation from causation in observational data|10.1038/s41467-019-14156-4|https://www.mendelianrandomization.com/index.php/software-code|
|Metagenomic Estimation of Dietary Intake (MEDI)|quantifying food-derived DNA in human faecal metagenomes|10.1038/s42255-025-01220-1|https://github.com/Gibbons-Lab/medi|
|OptimOTU|taxonomically aware approach to OTU clustering|10.48550/arXiv.2502.10350|https://github.com/brendanf/optimotu|
|FST-based Assessment of Variability across vectors of relative Abundances (FAVA)|Quantifying compositional variability in microbial communities|10.1073/pnas.2413211122|https://maikemorrison.github.io/FAVA/|
|Global Inventory of Floras and Traits (GIFT)|An R package to access the Global Inventory of Floras and Traits|10.1111/2041-210X.14213|https://biogeomacro.github.io/GIFT/|
|SpeSpeNet|interactive and user-friendly tool to create and explore microbial correlation networks|10.1093/ismeco/ycaf036|https://tbb.bio.uu.nl/SpeSpeNet/|
|Happy Belly Bioinformatics|resource for bioinformatics beginners||https://astrobiomike.github.io/|
|b3gbi |R package for analysing biodiversity data from GBIF data cubes||https://github.com/b-cubed-eu/b3gbi|
|gcube| R package for biodiversity data simulation||https://github.com/b-cubed-eu/gcube|
|eDNAjoint|R package for interpreting paired or semi-paired environmental DNA and traditional survey data in a Bayesian framework|10.1111/2041-210X.70000|https://github.com/ropensci/eDNAjoint|
|ProteoSeeker|Metagenomic Analysis Tool forAccessible and Comprehensive Metagenomic Exploration|10.1002/advs.202414877|https://github.com/SkretasLab/ProteoSeeker|
|DIVAnd (Data-Interpolating Variational Analysis in n dimensions)|performs an n-dimensional variational analysis/gridding of arbitrarily located observations|10.5194/gmd-7-225-2014|https://github.com/gher-uliege/DIVAnd.jl|
|COSMO Site|provide information on sea surface currents in the Mediterranean basin and around the Iberian Peninsula|10.1080/1755876X.2022.2102357|https://cosmo.icm.csic.es|
|Taxoniq|Taxon Information Query - fast, offline querying of NCBI Taxonomy and related data||https://github.com/taxoniq/taxoniq|
|Ecological Marine Unit (EMU) Explorer|web-based application that is used to explore different water characteristics available from NOAA's World Ocean Atlas||https://livingatlas.arcgis.com/emu/|
|NOAA Ocean Exploration Video Portal|||https://www.ncei.noaa.gov/access/ocean-exploration/video/|
|ORDNA (ORDination via Deep Neural Algorithm) |Deep-learning-based ordination for raw environmental DNA samples|10.1111/2041-210X.70033|https://gitlab.renkulab.io/dnai/ordna ; https://gitlab.renkulab.io/dnai/ORDNA-plots|
|rCRUX|rapid and versatile tool for generating metabarcoding reference libraries in R|10.1002/edn3.489|https://github.com/CalCOFI/rCRUX|
|refdb|Management of DNA reference libraries|10.1111/1755-0998.13723|https://fkeck.github.io/refdb/|
|Meta-Fish-Lib|generalised, dynamic DNA reference library for metabarcoding of fishes||https://github.com/genner-lab/meta-fish-lib|
|Phytool|ShinyApp to homogenise taxonomy of freshwater microalgae from DNA barcodes and microscopic observations|10.3897/mbmg.5.74096|https://caninuzzo.shinyapps.io/phytool_v1/ ; https://doi.org/10.57745/TIRNFD|
|SAND-UP (Strange ASV Names Detector Using Phylogenetic trees)|detect possible misassigned ASVs or refine the taxonomic assignment of some ASVs||https://github.com/Enorya/SAND-UP|
|eDITH (eDNA Integrating Transport and Hydrology)|explicit interpretation and prediction of environmental DNA (eDNA) data collected from river networks||https://lucarraro.github.io/eDITH/articles/eDITH.html|
|mGPS (Microbiome Geographic Population Structure)|microbiome fine-scale biogeography tool maps the transfer of antimicrobial resistance genes|10.1093/gbe/evae209|https://github.com/YaliZhang98/mGPS ; https://github.com/YaliZhang98/mGPS_interface|
|WEST COAST ESTUARIES EXPLORER|||https://estuaries.pacificfishhabitat.org|
|Global Ecosystem Typology|||https://global-ecosystems.org|
|lefser|implementation of LEfSe in R|10.1093/bioinformatics/btae707|https://github.com/waldronlab/lefser|
|ProtectedSeas Navigator|||https://navigatormap.org|
|ParAquaSeq|Database of Ecologically Annotated rRNA Sequences Covering Zoosporic Parasites|10.1111/1755-0998.14099|https://github.com/ParAqua-COST/ParAquaSeq_Repository|
|How to Interpret Statistical Models With marginaleffects |||https://marginaleffects.com|
|q2-predict-dysbiosis (Q2PD)|function-based gut microbiome health index|10.1101/2023.12.04.569909|https://github.com/Kizielins/q2-predict-dysbiosis|
|ReLTER|R interface for Environmental Observation in Long Term Ecological Research|10.1016/j.ecoinf.2024.102915|https://github.com/ropensci/ReLTER/|
|QCforSeqCode|Snakemake Pipeline to check the requirements for a prokaryotic assembly to be included in the SeqCode initiative||https://github.com/richardstoeckl/QCforSeqCode|
|EcoFoldDB|Protein structure-guided functional profiling of ecologically relevant microbial traits at the metagenome scale|10.1101/2025.04.02.646905|https://github.com/timghaly/EcoFoldDB|
|fastreeR|Fast Tree Reconstruction Tools for Genomics|10.1186/s12859-016-1186-3|https://github.com/gkanogiannis/fastreeR|
|TaxSEA|rapid interpretation of microbiome alterations using taxon set enrichment analysis and public databases|10.1093/bib/bbaf173|https://shiny.taxsea.app/|
|vAMPirus|amplicon processing and analysis program for studying viruses|10.1111/1755-0998.13978|https://github.com/Aveglia/vAMPirus|
|BOLD v4|Centralized Bioinformatics Platform for DNA-Based Biodiversity Data|10.1007/978-1-0716-3581-0_26|https://v4.boldsystems.org|
|Haplotype-level metabarcoding of freshwater macroinvertebrate species|prospective tool for population genetic analysis|10.1371/journal.pone.0289056|https://figshare.com/articles/dataset/Metabarcoding-inferred_haplotyping/15090180/1|
|bugphyzz|data resource and software for enrichment analysis of microbial physiologies||https://github.com/waldronlab/bugphyzz|
|BEREN|A bioinformatic tool for recovering Giant viruses, Polinton-like Viruses, and Virophages in metagenomic data|10.1101/2024.10.09.617401|https://gitlab.com/benminch1/BEREN|
|samestr|identifies shared strains between pairs of metagenomic samples based on the similarity of SNV profiles|10.1186/s40168-022-01251-w|https://github.com/danielpodlesny/samestr|
|unikseq2|Unique (& conserved) region identification in DNA sequences, using k-mers|10.1111/1755-0998.70014|https://github.com/bcgsc/unikseq|
|Extremophiles Genomic Signature Analysis|uncover new microbial organism pairs whose genomic signatures are similar, despite their maximal taxonomic differences|10.1101/2025.06.04.657665|https://github.com/Kari-Genomics-Lab/Extreme_Env_2|
|CODARFE (COmpositional Data Analises with Recursive Feature Elimination)|Unlocking the prediction of continuous environmental variables based on microbiome|10.1093/gigascience/giaf055|https://github.com/alerpaschoal/CODARFE|
|Microbial load predictor (MLP)|R function to predict the fecal microbial load (total microbial cell count per gram or cell density) based on the taxonomic profile of the human gut microbiome|10.1016/j.cell.2024.10.022|https://github.com/grp-bork/microbial_load_predictor|
|ROCK|digital normalization of whole genome sequencing data|10.21105/joss.03790|https://gitlab.pasteur.fr/vlegrand/ROCK|
|mbX|An R Package for Streamlined Microbiome Analysis|10.3390/stats8020044|https://github.com/utsavlamichhane/mbX-R-package/|
|PICRUSt2-SC|an update to the reference database used for functional prediction within PICRUSt2|10.1093/bioinformatics/btaf269|https://github.com/picrust/picrust2|
|Speciation & Population Genomics: a how-to-guide|||https://speciationgenomics.github.io/|
|MiCoDe (Microbiome Community Detector)|cluster a network of microbial taxa into communities using a Bayesian weighted stochastic block model|10.1093/bioinformatics/btaf384|https://lce.biohpc.swmed.edu/micode/ ; https://github.com/klutz920/MiCoDe|
|ATCCfinder |identify commercially available American Type Culture Collection strains based on sequence queries|10.7717/peerj.19832|https://github.com/lanl/ATCCfinder|
|Resources for Learning Bioinformatics and Computational Biology|||https://learnbioinformatics.org|
|A-microbiologist-wants-to-compute|list of learning online resources related to microbiome computational science and tools||https://github.com/SvetlanaUP/A-microbiologist-wants-to-compute|
|MBPD|A multiple bacterial pathogen detection pipeline for One Health practices||https://github.com/LorMeBioAI/MBPD|
|taxburst|sunburst charts for taxonomy, based on Krona||https://github.com/taxburst/taxburst|
|BOLD Library Curation Pipeline|Snakemake pipeline for processing and curating BOLD Systems barcode reference sequence data||https://github.com/bge-barcoding/bold-library-curation
|Library Curation Tool|curate records from BOLD database||https://github.com/bge-barcoding/BGE_library_curation_tool|
|PIMENTO| A PrIMEr infereNce TOolkit to facilitate large-scale calling of amplicon sequence variants|10.1101/2025.07.04.663168|https://github.com/EBI-Metagenomics/PIMENTO|
|eDNA2IQI|automates infaunal quality index (IQI) prediction from raw FASTQ files |10.1016/j.aquaculture.2025.743126|https://github.com/SAMS-UK/eDNA2IQI|
|eDNAoccupancy|R package for multi-scale occupancy modeling of environmental DNA data|10.1111/1755-0998.12735|https://code.usgs.gov/wetland-and-aquatic-research-center/ednaoccupancy|
|ECOSYSMIC|Genome-scale community modelling|10.1038/s41467-024-46374-w|https://gitlab.univ-nantes.fr/ecosysmic|
|APEX pathogen|predicting species-specific antimicrobial activity against pathogens using deep learning|10.1038/s41564-025-02061-0|https://gitlab.com/machine-biology-group-public/apex-pathogen|
|Database of Antimicrobial Activity and Structure of Peptides (DBAASP) ||10.1093/nar/gkaa991|https://dbaasp.org/home|
|DRAMP (Data repository of antimicrobial peptides)||10.1093/nar/gkae1046|http://dramp.cpu-bioinfor.org|
|Antimicrobial Peptide Database (APD)||10.1093/nar/gkh025|https://aps.unmc.edu|
|ggClusterNet 2|R package for microbial co-occurrence networks and associated indicator correlation patterns|10.1002/imt2.70041|https://github.com/taowenmicro/ggClusterNet|
|microbetag|simplifying microbial network interpretation|10.1186/s13059-025-03769-2|https://github.com/msysbio/microbetag|
|WhereDoGGo|prokaryotic phylogenomics||https://github.com/MEDEAlab/WhereDoGGo|
|Omnicrobe|database of microbial habitats and phenotypes|10.1371/journal.pone.0272473|https://forgemia.inrae.fr/omnicrobe|
|The Microbe Directory (TMD)|a centralized database for biological interpretation of microbiome data|10.1093/database/baaf060|https://themicrobedirectory.shinyapps.io/website/|
|hvrlocator|identify spanning hypervariable region(s) from amplicon sequencing variants or SRA public runs (SRR)|10.1101/2025.07.24.666487|https://github.com/fbcorrea/hvrlocator|
|MiCoDa (Microbial Community Database)|searchable database that hosts curated and processed 16S rRNA gene amplicon sequences||https://micoda.idiv.de/v1|
|OceanOmics-amplicon-nf (inluding FAIRe-fied Hydronaut)|creates a phyloseq object from eDNA amplicon data||https://github.com/MinderooFoundation/OceanOmics-amplicon-nf|
|Metahood|snakemake pipeline aimed at general analysis on metagenomic shrots reads||https://github.com/Sebastien-Raguideau/Metahood|
|ASVmaker|generate reference databases for allocating amplicon sequencing data|10.3390/plants12213678|https://github.com/cplessis/ASVmaker|
|EUKARYOME|community-curated research database for nuclear ribosomal 18S rRNA (SSU), internal transcribed spacer (ITS), and 28S rRNA (LSU) markers for all eukaryotes|10.1093/database/baae043|https://eukaryome.org|
|biodumpy|A Comprehensive Biological Data Downloader||https://biodumpy.readthedocs.io/en/latest/index.html|
|PhILR (Phylogenetic Isometric Log-Ratio) Transform||10.7554/eLife.21887|https://bioconductor.org/packages/release/bioc/html/philr.html|
|StrataSeq|A Workflow for Rapid Development of Molecular Databases for Hard-To-Identify Species|10.1002/ece3.72375|https://figshare.com/articles/dataset/Tables_S1_S2_S3_S4/28622285|
|AquaX|An enhanced and revised AquaMaps framework to model marine species distributions and biodiversity|10.1101/2025.10.19.683322|https://www.aquamaps.org|
|SelNeTime| inferring effective population size and selection intensity from genomic time series data|10.1101/2024.11.06.622284|https://forge.inrae.fr/genetic-time-series/selnetime|
|MMonitor|Real-Time Monitoring of Microbial Communities Using Long Reads|10.1101/2025.09.08.674848|https://www.mmonitor.org|
|eDNAPlus|A Unifying Modeling Framework for DNA-based Biodiversity Monitoring|10.1080/01621459.2024.2412362|https://datadryad.org/dataset/doi:10.5061/dryad.4f4qrfjjb|
|Joint species distribution modelling (JSDM) to predict distributions of vulnerable marine ecosystems (VMEs)||10.1007/s10531-024-02904-y|https://github.com/Fabrice-Stephenson/Using_JSDM_to_predict_VME|
|MetaGraph (Google for DNA)|scalable construction of annotated genome graphs and sequence-to-graph alignment|10.1038/s41586-025-09603-w|https://github.com/ratschlab/metagraph ; https://metagraph.ethz.ch/search|
|MAMBO (Metabarcoding Analysis using Modeled Bayesian Occurrences)|analyze eDNA metabarcoding sequence data from multiple trophic levels to identify drivers and patterns of biodiversity|10.1111/1755-0998.70160 |https://github.com/nvpatin/MAMBO|
|Compute PTR (CoPTR)|a tool for computing peak-to-trough ratios (PTRs) from complete reference genomes and assemblies|10.1101/gr.275533.121|https://github.com/tyjo/coptr|
|Phylo-MIP|Phylogeny-based Molecular Identification Pipeline for DNA metabarcoding|10.1101/2025.11.10.687572|https://github.com/shigebio/Phylo-MIP|
|Metalog|curated and harmonised contextual data for global metagenomics samples|10.1093/nar/gkaf1118|https://metalog.embl.de|
|eDNAmap|A Metabarcoding Web Tool for Comparing Marine Biodiversity, With Special Reference to Teleost Fish|10.1111/1755-0998.70066|https://github.com/jun-inoue/eDNAmap|
|PRIME (Phenotypic Reference for Integrated Microbiome Enrichment)|a database for 16S rRNA microbiome data with phenotypic reference and comprehensive metadata|10.1093/nar/gkaf1057|https://primedb.sjtu.edu.cn|
|ulrb|Unsupervised Learning Based Definition of Microbial Rare Biosphere|10.1038/s42003-025-07912-4|https://pascoalf.github.io/ulrb/|
|metaGEENOME|integrated framework for differential abundance analysis of 16S rRNA microbiome data in cross-sectional and longitudinal studies|10.1186/s12859-025-06217-x|https://github.com/M-Mysara/metaGEENOME|
|ECKOchain|A FAIR blockchain-based database for long-term ecological data|10.1111/2041-210X.14280|https://ecko.uib.no|
|SEND (Share Easily bioiNformatics Data)|a suite of tools for the easy sharing of linked biological data|10.1093/database/baaf068|https://github.com/targetmine|
|DeepCOI|language model-driven framework for fast and accurate taxonomic assignment in animal metabarcoding|10.1186/s13059-025-03861-7|https://github.com/DMnBI/DeepCOI|
|eKOI|taxonomic database for eukaryotic mitochondrial cytochrome oxidase subunit I gene|10.1093/database/baaf057|https://github.com/rubenmiguens/eKOI_taxonomy_database|
|Disentangling marine microbial networks across space||10.1101/2021.07.12.451729|https://github.com/InaMariaDeutschmann/GlobalNetworkMalaspinaHotmix|
|BaNaNA (Barcoding Nanopore Neat Annotator)|pipeline for obtaining OTUs from Nanopore reads|10.3897/mbmg.9.163750|https://github.com/ibe-uw/BaNaNA|
|Emu|species-level microbial community profiling of full-length 16S rRNA Oxford Nanopore sequencing data|10.1038/s41592-022-01520-4|https://gitlab.com/treangenlab/emu|
|MetaPONT|Metagenomic Taxonomy Pipeline for ONT sequencing|10.1128/msystems.00750-21|https://github.com/microbiome-gastro-UMG/MeTaPONT/|
|Learning Bioinformatics At Home|||https://github.com/harvardinformatics/learning-bioinformatics-at-home|
|BAQLaVa|Bioinformatic Application for Quantification and Labeling of Viral taxonomy||https://huttenhower.sph.harvard.edu/baqlava/|
|MaAsLin 3|Microbiome Multivariable Associations with Linear Models|10.1101/2024.12.13.628459|https://github.com/biobakery/maaslin3|
|proGenomes4|annotated high-quality prokaryotic genomes |10.1093/nar/gkaf1208|https://progenomes.embl.de/|
|metaTraits|a large-scale integration of microbial phenotypic trait information||https://metatraits.embl.de|
|MPrESS|R-Package for Accurately Predicting Power for Comparisons of 16S rRNA Microbiome Taxa Distributions|10.3390/microorganisms11051166|https://github.com/thclarke/MPress|
|FALAPhyl (Forays into Automating Laborious Analyses of Phylogeny)|Open-Source Pipelines for Scalable 16s rRNA Microbiome Data Processing and Visualization|10.1101/2025.08.19.670115|https://github.com/khalidtab/FALAPhyl|
| FAVABEAN (Fast Amplicon Variant Annotation, Binning, Error-correction And ANalysis)|Open-Source Pipelines for Scalable 16s rRNA Microbiome Data Processing and Visualization|10.1101/2025.08.19.670115|https://github.com/khalidtab/FAVABEAN|
|phylotaR|An automated pipeline for retrieving orthologous DNA sequences from GenBank in R|10.3390/life8020020|https://github.com/ropensci/phylotaR/|
|VirJenDB| a FAIR (meta)data and bioinformatics platform for all viruses|10.1093/nar/gkaf1224|https://virjendb.org|
|demultiplexer|python script to demultiplex Illumina reads that are tagged in addition to the index reads||https://github.com/DominikBuchner/demultiplexer|
|nf-core/pathogensurveillance|population genomics pipeline for pathogen identification, variant detection, and biosurveillance|10.1101/2025.10.31.685798|https://nf-co.re/pathogensurveillance/1.1.0|
|ggvegan|ggplot-based plots for vegan||https://github.com/gavinsimpson/ggvegan|
|microbiomestarplots|tool for creating star plot figures from compositional taxonomic phyloseq objects and other data frames||https://github.com/kadenmuffett/microbiomestarplots|
|Logan|compressed FASTA files for all individual SRA accessions, in the form of unitigs and contigs|10.1101/2024.07.30.605881|https://registry.opendata.aws/pasteur-logan/|
|Eduomics|a Nextflow pipeline to simulate -omics data for education|10.1093/nargab/lqag029|https://github.com/lescai-teaching/eduomics|
|edna-science|eDNA scientific analysis and data visualization||https://github.com/iobis/edna-science|
|ednagaps|R package for eDNA reference database gap analysis||https://github.com/iobis/ednagaps|
|gcMeta 2025|global repository of metagenome-assembled genomes enabling cross-ecosystem microbial discovery and function research|10.1093/nar/gkaf1115|https://gcmeta.wdcm.org|
|resLens|genomic language models to enhance antibiotic resistance gene detection|10.1101/2025.07.08.663767|https://github.com/omicsEye/resLens|
|Microbiome Datahub|open-access platform integrating environmental metadata, taxonomy, and functional annotation for comprehensive metagenome-assembled genome datasets|10.1186/s40168-026-02385-x|https://mdatahub.org/apimanual|
|DeeDeeExperiment| infrastructure for integrating and managing omics data analysis results in R/Bioconductor|10.1093/bioinformatics/btag157|https://bioconductor.org/packages/release/bioc/html/DeeDeeExperiment.html|
|XTree|fast, k-mer-based sequence lookup and tallying tool designed for efficient analysis of metagenomic data||https://github.com/two-frontiers-project/2FP-XTree|
|PathogenFinder2|Whole-genome prediction of bacterial pathogenic capacity on novel bacteria using protein language models|10.1093/bioinformatics/btag129|https://genepi.dk/pathogenfinder2|
|DIYNAFLUOR|DIY Nucleic Acid FLUORometer|10.1101/2024.12.16.626200|https://github.com/traulab/DIYNAFLUOR|
|GSPR|global soil plasmidome resource|10.1038/s41467-025-65102-6|https://github.com/Matt-BF/GSPR|
|TaxTriage| An Open-Source Metagenomic Sequencing Data Analysis Pipeline Enabling Putative Pathogen Detection|10.1101/2025.07.16.664785|https://github.com/jhuapl-bio/taxtriage|
|TaxonMatch|Integrating Taxonomic Data from GBIF, NCBI, iNaturalist, PaleoDB, IUCN and other sources||https://github.com/MoultDB/TaxonMatch|
|MATRIX (Microbial Activity and Total cell quantification via Rapid Imaging and eXtraction|Rapid Quantification of Total and Active Microbial Cells with Single-Cell Phenotypes for Environmental Microbiomes|10.64898/2026.03.16.712149|https://github.com/DatInsights-com/process_quantom ; https://github.com/ShadeLab/MATRIX_CellQuantification_2026|
|Metagenomic Population Tracking with ANIr|Tracking prokaryote populations across samples with short-read mapping, MAGs, and population threshold detection|10.1093/ismeco/ycag068|https://github.com/rotheconrad/Metagenomic_Population_Tracking|
|ggvegan|ggplot2-based plots for vegan||https://gavinsimpson.github.io/ggvegan/|
|microbiomestarplots|tool for creating star plot figures from compositional taxonomic phyloseq objects and other data frames||https://github.com/kadenmuffett/microbiomestarplots|
|AURORA Shiny App - streamlining biodiversity data sharing|integrated Shiny application designed to streamline the preparation, validation, and export of both marine and terrestrial biodiversity datasets into Darwin Core tables ||http://bio-shiny.ua.pt:3838/aurora/|
|SeqHub|explore, annotate, and share sequence data with functional insights||https://seqhub.org|
|Data Availability Checklist|data-consciouschecklistforthereviewersof'omicsstudieswhochampionopenscience|10.31222/osf.io/2aefg_v1|https://github.com/merenlab/data-availability-checklist/|
|MetaTree|interactive web platform for aligned hierarchical data visualization and multi-group comparison|10.1186/s12859-026-06475-3|https://byemaxx.github.io/MetaTree|
|WitChi|detects and prunes compositionally biased columns in multiple sequence alignments (MSAs) using empirical chi-squared testing|10.1101/2025.07.14.663642|https://github.com/stephkoest/witchi|
|PRONAME|processing Nanopore metabarcoding sequencing data|10.3389/fbinf.2024.1483255|https://github.com/benn888/PRONAME|
|Natrix2| bioinformatics pipeline for the preprocessing of long and short raw sequencing data|10.3897/mbmg.7.109389|https://github.com/dbeisser/Natrix2|
|BIOWATCH|R shiny application for the detection of species of interest in metabarcoding datasets, enables the user to create custom reference databases from public databases|10.1186/s12859-026-06468-2|https://github.com/BEMlabKAUST/BIOWATCH_ShinyApp/|
|GeneScanner|profiling genetic variation across bacterial populations|10.1099/mgen.0.001714|https://github.com/Sheppard-Lab/GeneScanner|
|CoDA (challenges of compositional data analysis)|Functions for microbiome data analysis that take into account its compositional nature|10.64898/2026.04.28.721392|https://cran.r-project.org/web/packages/coda4microbiome/|
|Bioinformatics basics for trainee students|resource for accessing commonly used commands in early bioiformatics.||https://github.com/filonico/UNIX_and_bash_basics|
|TaxoFlow|how to wrap a metagenomics pipeline using Nextflow||https://taxoflow.work|
|BioStudies|A Platform for Life Sciences Study Data Dissemination|10.1016/j.jmb.2026.169874|https://www.ebi.ac.uk/biostudies/|
|eDNA Viewer|interactive platform for exploring biodiversity data generated through environmental DNA (eDNA) metabarcoding, developed in collaboration with eDNA Frontiers||https://viewer.ednafrontiers.com/#!/map|
|N-SDM 2.0|nested species distribution modelling|10.1002/ecog.08547|https://github.com/antadde/N-SDM|
|DataPLANT |provide a sustainable and well annotated data management platform for plant sciences|10.1007/s42979-026-05010-8|https://github.com/nfdi4plants|
|HVRLocator|workflow to identify spanning hypervariable region(s) from amplicon sequencing variants or SRA public runs (SRR). It aligns query sequences to a reference E. coli full-length 16S rRNA gene and identifies the spanning region through alignment|10.1093/gigascience/giag040|https://github.com/fbcorrea/hvrlocator|
|A phylogenetic turn for eDNA metabarcoding||10.64898/2026.06.11.731524|https://github.com/HaderleRachel/A-phylogenetic-turn-for-eDNA-metabarcoding|
|NeMO (Nested eDNA Metabarcoding Occupancy)|A Flexible R Package for Nested Multi‐Species Occupancy Modeling and eDNA Study Optimization|10.1002/edn3.70326|https://github.com/bastien-mace/NeMO|
|||||
|||||
